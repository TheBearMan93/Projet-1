(function(factory) {
    ...
    providers['OpenStreetMap_BlackAndWhite'] = {
        title: 'osm bw',
        icon: './images/openstreetmap_blackandwhite.png',
    ...
    providers['OpenStreetMap_DE'] = {
        title: 'osm de',
        icon: './images/openstreetmap_de.png',
    ...
    providers['Esri_OceanBasemap'] = {
        title: 'esri ocean',
        icon: './images/esri_oceanbasemap.png',
    ...
    providers['HERE_normalDay'] = {
        title: 'normalday',
        icon: './images/here_normalday.png',
    ...
    providers['HERE_normalDayGrey'] = {
        ...
        icon: './images/here_normaldaygrey.png',
    ...
    providers['CartoDB_Positron'] = {
        title: 'positron',
        icon: './images//cartodb_positron.png',
